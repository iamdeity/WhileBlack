...
public class JMail  {
    //String email;
    public static String myEmailAccount = "17682313062@sina.cn";
    public static String myEmailPassword = "w3cschool";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        message.setFrom(new InternetAddress(sendMail, "修改密码", "UTF-8"));
        ...
        message.setContent("您的验证码随机生成为："+ num+"。五分钟有效，请尽快验证", "text/html;charset=UTF-8");
